...
const MIN_PASSWORD = 8; // deve bater com o valor em auth.js (front-end)
...
router.post('/register', async (req, res) => {
    try {
        ...
        // Senha mínima (validação no servidor — independente do front-end)
        ...
        await db.prepare(
            'INSERT INTO users (name, email, phone, cpf, address, password, role) VALUES (?, ?, ?, ?, ?, ?, ?)'
